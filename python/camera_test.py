...
from pytheia_sfm import FisheyeCameraModel
...
def TestSetFromCameraintrinsicsPrior(prior):
...
'''
def GTEST_SetFromCameraIntrinsicsPriors():
...
GTEST_SetFromCameraIntrinsicsPriors()
